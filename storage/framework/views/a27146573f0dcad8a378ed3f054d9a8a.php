...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Pilih Unit - ' . $program->title)]); ?>
    ...
    <section class="relative pb-24 z-20 min-h-[400px]"
        ...
        <div x-show="!isSearching" class="flex flex-wrap justify-center gap-8 perspective-1000">
            <?php $__empty_1 = true; $__currentLoopData = $unitKerjas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <a href="<?php echo e(route('public.unit.landing', ['program' => $program, 'unitKerja' => $unit])); ?>"
                    ...
                    <div class="bg-white rounded-[1.8rem] p-6 h-full flex flex-col relative overflow-hidden group-hover:bg-teal-50/10 transition-colors duration-500">
                        ...
                        <div class="flex justify-between items-start mb-6 relative z-10">
                            ...
                            ?>
                            <div class="w-16 h-16 rounded-2xl bg-gradient-to-br <?php echo e($colorClass); ?> p-0.5 shadow-lg shadow-slate-200 group-hover:scale-105 transition-transform duration-500">
