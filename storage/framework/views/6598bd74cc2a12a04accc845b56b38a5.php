...
<div class="space-y-1">
    ...
    <div class="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center">
            ...
            <a href="<?php echo e(route('superadmin.users.create')); ?>" class="mt-4 md:mt-0 bg-green-600 text-white px-5 py-2 rounded-lg font-medium hover:bg-green-700 transition duration-300 shadow-sm flex items-center space-x-2 self-start md:self-end">
    ...
    <div class="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
        <form action="<?php echo e(route('superadmin.users.index')); ?>" method="GET" class="space-y-4 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-4">
            <div>
                ...
                <div class="relative mt-1">
                    ...
                    <input type="text" id="search" name="search" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500" placeholder="Ketik nama atau email..." value="<?php echo e(request('search')); ?>">
                </div>
            </div>
            <div>
            ...
            <div class="flex items-end gap-3">
                ...
                <a href="<?php echo e(route('superadmin.users.index')); ?>" class="px-4 py-2 text-sm font-semibold text-gray-600 hover:text-gray-800 border border-gray-300 rounded-md shadow-sm bg-white hover:bg-gray-50">Reset</a>
            </div>
        </form>
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-indigo-50/50 transition-colors duration-200">
                    ...
                    <td class="px-6 py-4 align-middle">
                        <div class="font-semibold text-gray-900"><?php echo e($user->username); ?></div>
                        <div class="text-sm text-gray-500"><?php echo e($user->email); ?></div>
                    </td>

                    
                    <td class="px-6 py-4 align-middle">
                        <div class="font-semibold text-gray-800"><?php echo e($user->role->role_name ?? 'N/A'); ?></div>
                        <?php if($user->unitKerja): ?>
                        <div class="text-sm text-gray-500"><?php echo e($user->unitKerja->unit_kerja_name); ?></div>
                        <?php endif; ?>
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium align-middle">
                        <div class="flex items-center justify-center space-x-4">
                            <a href="<?php echo e(route('superadmin.users.edit', $user)); ?>" class="text-indigo-600 hover:text-indigo-900" title="Edit">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                            </a>
                            <?php if(Auth::id() !== $user->id): ?>
                            <button type="button" @click="$dispatch('open-delete-modal', { url: '<?php echo e(route('superadmin.users.destroy', $user)); ?>', name: '<?php echo e(addslashes($user->username)); ?>' })" class="text-red-600 hover:text-red-800" title="Hapus">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
