...
<div class="relative z-10 space-y-6">
    ...
    <div class="bg-white/60 backdrop-blur-xl rounded-3xl px-6 py-5 border border-white/40 shadow-lg relative overflow-hidden group hover:shadow-indigo-100/50 transition-all duration-500">
        ...
        <div class="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <a href="<?php echo e(route('superadmin.programs.create')); ?>"
    ...
    <div class="bg-white/60 backdrop-blur-xl border border-white/40 shadow-lg rounded-2xl p-4">
        <form action="<?php echo e(route('superadmin.programs.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div class="md:col-span-3">
                <select name="unit_id" class="block w-full py-2.5 px-3 border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white/50 text-gray-600 cursor-pointer hover:bg-white transition-colors shadow-sm">
                    ...
                    <option value="institutional" <?php echo e(request('unit_id') == 'institutional' ? 'selected' : ''); ?>>🏢 Institusional (Global)</option>
                    <option value="local" <?php echo e(request('unit_id') == 'local' ? 'selected' : ''); ?>>📍 Lokal (Unit Kerja)</option>
                </select>
            </div>
            ...
            <div class="md:col-span-1 flex gap-2">
                ...
                <?php if(request()->hasany(['search', 'status', 'unit_id'])): ?>
                <a href="<?php echo e(route('superadmin.programs.index')); ?>" class="w-full bg-white hover:bg-rose-50 text-slate-400 hover:text-rose-500 border border-gray-200 rounded-xl transition-all shadow-sm flex items-center justify-center" title="Reset Filter">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <tr class="hover:bg-white/60 transition-colors duration-200 group">
                        ...
                        <td class="py-4 px-6 align-middle">
                            <div class="flex flex-col max-w-xs">
                                <div class="flex items-center gap-2 mb-1">
                                    <a href="<?php echo e(route('superadmin.programs.questions.index', $program)); ?>" class="font-bold text-gray-800 text-base group-hover:text-indigo-600 transition-colors line-clamp-1">
                                ...
                                <div class="flex items-center gap-2 text-xs text-slate-400 font-medium">
                                    <span class="flex items-center gap-1 bg-slate-50 px-2 py-1 rounded-lg border border-slate-100">
                                        ...
                                        <?php echo e($program->start_date?->format('d M Y') ?? '-'); ?> — <?php echo e($program->end_date?->format('d M Y') ?? '-'); ?>
                        ...
                        <td class="py-4 px-6 align-middle">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-[10px] text-slate-500 font-bold uppercase tracking-wide mt-0.5"><?php echo e(Str::limit($program->unitKerja->uk_short_name ?? 'N/A', 10)); ?></p>
                                </div>
                            </div>
                            <?php endif; ?>
                        </td>
                        ...
                        <td class="py-4 px-6 text-center align-middle">
                            <div class="inline-flex bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                                <div class="px-3 py-2 bg-slate-50 border-r border-gray-200">
                                    ...
                                    <span class="block text-sm font-black text-slate-700"><?php echo e($program->question_sections_count ?? 0); ?></span>
                                </div>
                                <div class="px-3 py-2">
                                    <span class="block text-xs text-indigo-300 font-bold uppercase">Soal</span>
                                    <span class="block text-sm font-black text-indigo-600"><?php echo e($program->questions_count ?? 0); ?></span>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="py-4 px-6 text-center align-middle">
                            <div class="flex flex-col gap-2 max-w-[150px] mx-auto">
                                ...
                                <a href="<?php echo e(route('superadmin.programs.results', $program)); ?>"
                                ...
                                <div class="flex gap-1.5 flex-wrap justify-center">
                                    ...
                                    <a href="<?php echo e(route('superadmin.programs.builder', $program)); ?>"
                                    ...
                                    <a href="<?php echo e(route('superadmin.programs.questions.index', $program)); ?>" class="flex-1 bg-white text-blue-600 border border-blue-100 p-1.5 rounded-lg hover:bg-blue-500 hover:text-white transition-colors shadow-sm" title="Kelola Soal Survei">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <a href="<?php echo e(route('superadmin.programs.edit', $program)); ?>" class="flex-1 bg-white text-amber-600 border border-amber-100 p-1.5 rounded-lg hover:bg-amber-500 hover:text-white transition-colors shadow-sm" title="Edit Info Program">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <div class="w-full flex gap-1.5 mt-1.5">
                                        ...
                                        <button type="button"
                                            @click="$dispatch('open-delete-modal', { url: '<?php echo e(route('superadmin.programs.destroy', $program)); ?>', name: '<?php echo e(addslashes($program->title)); ?>' })"
                    ...
                    <tr>
                        <td colspan="5" class="py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <?php if(request()->hasany(['search', 'status', 'unit_id'])): ?>
                                <a href="<?php echo e(route('superadmin.programs.index')); ?>" class="inline-flex items-center gap-2 text-indigo-600 hover:text-indigo-800 font-bold text-sm hover:underline">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <?php else: ?>
                                <a href="<?php echo e(route('superadmin.programs.create')); ?>" class="inline-block bg-indigo-600 text-white px-6 py-2.5 rounded-xl text-sm font-bold hover:bg-indigo-700 transition-all shadow-lg hover:shadow-indigo-500/30 hover:-translate-y-1">
