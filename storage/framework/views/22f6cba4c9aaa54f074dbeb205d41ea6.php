                        ...
                        <td class="py-4 px-6 text-center align-middle">
                            <div class="flex flex-col gap-2 max-w-[150px] mx-auto">
                                ...
                                <div class="flex gap-1.5">
                                    ...
                                    <a href="<?php echo e(route('superadmin.programs.questions.index', $program)); ?>" class="flex-1 bg-white text-blue-600 border border-blue-100 p-1.5 rounded-lg hover:bg-blue-500 hover:text-white transition-colors shadow-sm" title="Kelola Pertanyaan">
                                    ...
                                    <a href="<?php echo e(route('superadmin.programs.edit', $program)); ?>" class="flex-1 bg-white text-amber-600 border border-amber-100 p-1.5 rounded-lg hover:bg-amber-500 hover:text-white transition-colors shadow-sm" title="Edit Program">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
