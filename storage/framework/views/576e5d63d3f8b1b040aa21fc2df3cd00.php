...
<div class="relative z-10 space-y-8"
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    <nav class="flex items-center text-xs font-medium text-slate-500 mb-1 space-x-2">
                        <a href="<?php echo e(route('superadmin.programs.index')); ?>" class="hover:text-indigo-600 transition-colors">Program</a>
                    ...
                    <p class="text-slate-500 text-sm font-medium mt-0.5 line-clamp-1">
                        Program: <span class="text-indigo-600 font-bold"><?php echo e($program->title); ?></span>
                    </p>
                </div>
            </div>

            <div class="flex flex-wrap items-center gap-3">
                <a href="<?php echo e(route('superadmin.programs.index')); ?>" class="px-4 py-2 bg-white border border-slate-200 text-slate-600 rounded-xl text-xs font-bold hover:bg-slate-50 transition shadow-sm">
                    Kembali
                </a>
    ...
    <div x-ref="sectionContainer" class="space-y-6 pb-10">
        ...
        <div data-id="<?php echo e($section->id); ?>" class="bg-white/80 backdrop-blur-md rounded-3xl border border-white/50 shadow-sm hover:shadow-md transition-all duration-300 group/section">
            ...
            <div class="flex items-center justify-between p-5 border-b border-slate-100 bg-gradient-to-r from-slate-50/80 to-transparent rounded-t-3xl">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mt-0.5"><?php echo e($section->description); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-1 opacity-60 group-hover/section:opacity-100 transition-opacity">
                    ...
                    <button @click="$dispatch('open-delete-modal', { url: '<?php echo e(route('superadmin.sections.destroy', $section)); ?>', name: '<?php echo e(addslashes($section->title)); ?>' })"
            ...
            <div class="p-5 bg-white/40 rounded-b-3xl" x-data="questionSubManager(<?php echo json_encode($section->questions->pluck('id'), 15, 512) ?>)" x-init="initQuestionSortable('<?php echo e(route('superadmin.sections.questions.reorder', $section)); ?>')">
                    ...
                    <div data-id="<?php echo e($question->id); ?>" x-data="{ isOptionsVisible: false }"
                        ...
                        <div class="flex items-start gap-3">
                                ...
                                <div x-show="isOptionsVisible" x-collapse class="mt-4 pl-9">
                                    <div class="flex flex-wrap gap-2">
                                        ...
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-[11px] font-medium bg-slate-50 text-slate-600 border border-slate-200">
                                            ...
                                            <span class="bg-indigo-100 text-indigo-600 px-1.5 rounded text-[10px] font-bold ml-1"><?php echo e($option->option_score); ?></span>
                                        </span>
                            ...
                            <div class="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity pt-0.5">
                                <a href="<?php echo e(route('superadmin.sections.questions.edit', ['section' => $section, 'question' => $question])); ?>"
                                    class="p-1.5 text-slate-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                    </svg>
                                </a>
                                <button @click="$dispatch('open-delete-modal', { url: '<?php echo e(route('superadmin.sections.questions.destroy', ['section' => $section, 'question' => $question])); ?>', name: '<?php echo e(addslashes($question->question_body)); ?>' })"
                ...
                <div class="flex items-center justify-between mt-4 pt-4 border-t border-slate-100">
                    ...
                    <a href="<?php echo e(route('superadmin.sections.questions.create', $section)); ?>"
    ...
    <div x-cloak x-show="showAddModal" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-center justify-center min-h-screen px-4 text-center">
            ...
            <div x-show="showAddModal" x-transition.scale class="inline-block w-full max-w-lg p-8 my-8 text-left align-middle transition-all transform bg-white rounded-3xl shadow-2xl relative z-10">
                ...
                <form action="<?php echo e(route('superadmin.programs.sections.store', $program)); ?>" method="POST" class="space-y-5">
                    <?php echo csrf_field(); ?>
                    <div>
