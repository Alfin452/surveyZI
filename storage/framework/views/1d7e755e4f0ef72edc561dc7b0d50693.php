...
<div class="relative z-10 space-y-8" x-data="{ activeTab: 'institusional' }">
    ...
    <div class="bg-white/60 backdrop-blur-xl rounded-3xl px-6 py-5 border border-white/40 shadow-lg relative overflow-hidden group hover:shadow-teal-100/50 transition-all duration-500">
        ...
        <div class="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <a href="<?php echo e(route('unitkerja.admin.my-programs.create')); ?>"
    ...
    <div class="bg-white/40 backdrop-blur-md p-1.5 rounded-2xl inline-flex items-center gap-2 border border-white/40 shadow-sm">
        <button @click="activeTab = 'institusional'"
            ...
            <span :class="activeTab === 'institusional' ? 'bg-teal-100 text-teal-600' : 'bg-slate-200/50 text-slate-500'"
                ...
                <?php echo e($institutionalPrograms->count()); ?>
                            ...
                            <tr class="hover:bg-white/60 transition-colors duration-200 group">
                                <td class="py-4 px-6 align-middle">
                                    <div class="flex flex-col">
                                        <span class="font-bold text-gray-800 text-base group-hover:text-teal-600 transition-colors"><?php echo e($program->title); ?></span>
                                        <span class="text-xs text-slate-500 mt-1 line-clamp-1"><?php echo e($program->description); ?></span>
                                ...
                                <td class="py-4 px-6 text-center align-middle">
                                    <a href="<?php echo e(route('unitkerja.admin.programs.results', $program)); ?>"
                                        class="inline-flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-900 text-white rounded-xl text-xs font-bold shadow-md hover:shadow-slate-500/30 transition-all">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="text-gray-700 text-sm divide-y divide-gray-100/50">
                            ...
                            <tr class="hover:bg-white/60 transition-colors duration-200 group">
                                ...
                                <td class="py-4 px-6 align-middle">
                                    <div class="flex flex-col">
                                        <a href="<?php echo e(route('unitkerja.admin.programs.questions.index', $program)); ?>" class="font-bold text-gray-800 text-base group-hover:text-teal-600 transition-colors">
                                ...
                                <td class="py-4 px-6 text-center align-middle">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <a href="<?php echo e(route('unitkerja.admin.programs.results', $program)); ?>" class="p-2 text-teal-600 bg-teal-50 border border-teal-100 rounded-lg hover:bg-teal-500 hover:text-white transition-all shadow-sm" title="Hasil">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                            </svg>
                                        </a>
                                        
                                        <a href="<?php echo e(route('unitkerja.admin.programs.questions.index', $program)); ?>" class="p-2 text-blue-600 bg-blue-50 border border-blue-100 rounded-lg hover:bg-blue-500 hover:text-white transition-all shadow-sm" title="Pertanyaan">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                        </a>
                                        
                                        <a href="<?php echo e(route('unitkerja.admin.my-programs.edit', $program)); ?>" class="p-2 text-amber-600 bg-amber-50 border border-amber-100 rounded-lg hover:bg-amber-500 hover:text-white transition-all shadow-sm" title="Edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                            </svg>
                                        </a>
                                        
                                        <button @click="$dispatch('open-clone-modal', { url: '<?php echo e(route('unitkerja.admin.my-programs.clone', $program)); ?>', name: '<?php echo e(addslashes($program->title)); ?>' })" class="p-2 text-slate-600 bg-slate-50 border border-slate-200 rounded-lg hover:bg-slate-600 hover:text-white transition-all shadow-sm" title="Kloning">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                            </svg>
                                        </button>
                                        
                                        <button @click="$dispatch('open-delete-modal', { url: '<?php echo e(route('unitkerja.admin.my-programs.destroy', $program)); ?>', name: '<?php echo e(addslashes($program->title)); ?>' })" class="p-2 text-rose-600 bg-rose-50 border border-rose-100 rounded-lg hover:bg-rose-500 hover:text-white transition-all shadow-sm" title="Hapus">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <tr>
                                <td colspan="4" class="py-16 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <a href="<?php echo e(route('unitkerja.admin.my-programs.create')); ?>" class="mt-4 text-teal-600 hover:text-teal-800 font-bold text-sm underline">Buat Sekarang</a>
                                    </div>
                                </td>
                            </tr>
                            <?php endif; ?>
