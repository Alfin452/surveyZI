...
<div class="relative z-10 space-y-8" x-data="{ activeTab: 'myPrograms' }">
                            ...
                            <tr class="hover:bg-white/60 transition-colors duration-200 group">
                                ...
                                <td class="py-4 px-6 text-center align-middle">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <a href="<?php echo e(route('unitkerja.admin.programs.results', $program)); ?>" class="p-2 text-teal-600 bg-teal-50 border border-teal-100 rounded-lg hover:bg-teal-500 hover:text-white transition-all shadow-sm" title="Lihat Hasil">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                            </svg>
                                        </a>
                                        
                                        <a href="<?php echo e(route('unitkerja.admin.programs.questions.index', $program)); ?>" class="p-2 text-blue-600 bg-blue-50 border border-blue-100 rounded-lg hover:bg-blue-500 hover:text-white transition-all shadow-sm" title="Kelola Pertanyaan">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                        </a>
                                        
                                        <a href="<?php echo e(route('unitkerja.admin.my-programs.edit', $program)); ?>" class="p-2 text-amber-600 bg-amber-50 border border-amber-100 rounded-lg hover:bg-amber-500 hover:text-white transition-all shadow-sm" title="Edit Program">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                            </svg>
                                        </a>
                                        
                                        <a href="<?php echo e(route('unitkerja.admin.my-programs.builder', $program)); ?>"
                                        ...
                                        <button type="button"
                                            @click="$dispatch('open-clone-modal', { url: '<?php echo e(route('unitkerja.admin.my-programs.clone', $program)); ?>', name: '<?php echo e(addslashes($program->title)); ?>' })"
                                        ...
                                        <button type="button"
                                            @click="$dispatch('open-delete-modal', { url: '<?php echo e(route('unitkerja.admin.my-programs.destroy', $program)); ?>', name: '<?php echo e(addslashes($program->title)); ?>' })"
                            ...
                            <tr class="hover:bg-white/60 transition-colors duration-200 group">
                                ...
                                <td class="py-4 px-6 text-center align-middle">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="<?php echo e(route('unitkerja.admin.programs.results', $program)); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-900 text-white rounded-xl text-xs font-bold shadow-md hover:shadow-slate-500/30 transition-all">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                            </svg>
                                            Hasil
