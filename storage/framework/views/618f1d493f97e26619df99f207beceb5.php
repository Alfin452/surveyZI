...
<div class="space-y-2">
    ...
    <div class="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Selamat datang, <span class="font-semibold"><?php echo e(Auth::user()->username); ?></span>!</p>
                <p class="text-sm text-gray-500">Anda mengelola: <span class="font-semibold"><?php echo e($unitKerja->unit_kerja_name ?? 'N/A'); ?></span></p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <a href="<?php echo e(route('unitkerja.admin.programs.index')); ?>" class="text-sm font-medium text-teal-600 hover:text-teal-800 mt-4 inline-block">
                Lihat Program &rarr;
            </a>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800"><?php echo e($totalResponden); ?></p>
                </div>
            </div>
            <a href="<?php echo e(route('unitkerja.admin.programs.index')); ?>" class="text-sm font-medium text-yellow-700 hover:text-yellow-900 mt-4 inline-block">
