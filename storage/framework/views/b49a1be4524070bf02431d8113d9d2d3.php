        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-12">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center mb-16 hero-button-anim">
                    ...
                    <a href="<?php echo e(route('public.tentang')); ?>" class="group inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white border-2 border-cyan-400/50 rounded-2xl hover:bg-cyan-400/10 transition-all">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
                    <div class="stat-card card-anim group relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all hover:scale-105">
                        ...
                        <div class="relative">
                            <div class="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-br from-cyan-400 to-teal-400 mb-2 stat-number" data-target="<?php echo e($totalRespondents); ?>">0</div>
                    ...
                    <div class="stat-card card-anim group relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all hover:scale-105">
                        ...
                        <div class="relative">
                            <div class="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-br from-teal-400 to-blue-400 mb-2 stat-number" data-target="<?php echo e($totalPrograms); ?>">0</div>
                    ...
                    <div class="stat-card card-anim group relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all hover:scale-105">
                        ...
                        <div class="relative">
                            <div class="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-br from-blue-400 to-cyan-400 mb-2 stat-number" data-target="<?php echo e(round($satisfactionPercentage)); ?>">0</div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-4xl sm:text-5xl font-black text-slate-900 mb-4">
                    <?php echo e($featuredProgram->title); ?>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                <?php $__empty_1 = true; $__currentLoopData = $unitKerjas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unitKerja): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('public.unit.landing', ['program' => $featuredProgram, 'unitKerja' => $unitKerja])); ?>"
                    ...
                    <div class="relative">
                        <?php if($unitKerja->uk_short_name): ?>
                        <span class="inline-block px-3 py-1 bg-gradient-to-r from-cyan-100 to-teal-100 text-teal-700 text-xs font-bold rounded-full mb-4">
                            <?php echo e($unitKerja->uk_short_name); ?>
                ...
                <div class="col-span-full text-center py-16">
                    ...
                    <a href="<?php echo e(route('public.programs.list')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-cyan-600 to-teal-600 text-white font-bold rounded-xl hover:shadow-lg transition-all">
