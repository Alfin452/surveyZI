        ...
        <aside class="w-64 transition-all duration-300 flex-shrink-0 bg-gray-900 text-gray-300 flex flex-col p-4 shadow-xl">
            ...
            <nav class="flex-1 space-y-2">
                <a href="<?php echo e(route('unitkerja.admin.dashboard')); ?>"
                    ...
                    class="flex items-center gap-3 p-3 rounded-lg transition hover:bg-indigo-500/30 <?php echo e(request()->routeIs('unitkerja.admin.dashboard') ? 'bg-white/20 text-yellow-300' : 'text-gray-100'); ?>">
                ...
                <a href="<?php echo e(route('unitkerja.admin.profile.edit')); ?>"
                    @click="setTimeout(() => $store.globals.isLoading = true, 300)"
                    class="flex items-center gap-3 p-3 rounded-lg transition hover:bg-indigo-500/30 <?php echo e(request()->routeIs('unitkerja.admin.profile.*') ? 'bg-white/20 text-yellow-300' : 'text-gray-100'); ?>">
                ...
                <a href="<?php echo e(route('unitkerja.admin.programs.index')); ?>"
                    ...
                    class="flex items-center gap-3 p-3 rounded-lg transition-colors
                            <?php echo e(request()->routeIs('unitkerja.admin.programs.*') ? 'bg-gray-100 text-gray-900 font-semibold shadow' : 'text-gray-400 hover:bg-gray-800 hover:text-white'); ?>">
...
</html><?php /**PATH C:\laragon\www\surveyZI\resources\views/layouts/unit_kerja_admin.blade.php ENDPATH**/ ?>