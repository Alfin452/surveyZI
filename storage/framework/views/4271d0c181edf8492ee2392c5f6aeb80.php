...
<div class="relative z-10 space-y-6">
    ...
    <div class="bg-white/60 backdrop-blur-xl rounded-3xl px-6 py-5 border border-white/40 shadow-lg relative overflow-hidden group hover:shadow-indigo-100/50 transition-all duration-500">
        ...
        <div class="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <a href="<?php echo e(route('superadmin.unit-kerja.create')); ?>"
    ...
    <div class="bg-white/60 backdrop-blur-xl border border-white/40 shadow-lg rounded-2xl p-4">
        <form action="<?php echo e(route('superadmin.unit-kerja.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div class="md:col-span-2 flex gap-2">
                ...
                <?php if(request()->hasany(['search', 'type', 'parent'])): ?>
                <a href="<?php echo e(route('superadmin.unit-kerja.index')); ?>" class="w-full bg-white hover:bg-rose-50 text-slate-400 hover:text-rose-500 border border-gray-200 rounded-xl transition-all shadow-sm flex items-center justify-center" title="Reset Filter">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <tr class="hover:bg-white/60 transition-colors duration-200 group">
                        ...
                        <td class="py-4 px-6 align-middle">
                            ...
                            <span class="inline-flex items-center gap-1.5 bg-blue-50 text-blue-700 px-3 py-1 rounded-lg text-xs font-bold border border-blue-100 shadow-sm">
                                ...
                                <?php echo e($unit->tipeUnit->nama_tipe_unit); ?>
                        ...
                        <td class="py-4 px-6 align-middle">
                            ...
                            <div class="flex items-center gap-2 text-slate-600">
                                ...
                                <span class="font-medium text-xs"><?php echo e($unit->parent->unit_kerja_name); ?></span>
                            </div>
                            <?php else: ?>
                        ...
                        <td class="py-4 px-6 text-center align-middle">
                            <div class="inline-flex bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                                <div class="px-3 py-2 bg-slate-50 border-r border-gray-200" title="Jumlah Admin">
                                    ...
                                    <span class="block text-sm font-black text-slate-700"><?php echo e($unit->users_count); ?></span>
                                </div>
                                <div class="px-3 py-2" title="Jumlah Sub-unit">
                                    <span class="block text-[10px] text-emerald-400 font-bold uppercase">Sub</span>
                                    <span class="block text-sm font-black text-emerald-600"><?php echo e($unit->children_count); ?></span>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="py-4 px-6 text-center align-middle">
                            <div class="flex justify-center gap-2">
                                ...
                                <a href="<?php echo e(route('superadmin.unit-kerja.edit', $unit)); ?>" class="p-2 bg-white text-amber-600 border border-amber-100 rounded-lg hover:bg-amber-500 hover:text-white transition-all shadow-sm" title="Edit">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <button type="button"
                                    @click="$dispatch('open-delete-modal', { url: '<?php echo e(route('superadmin.unit-kerja.destroy', $unit)); ?>', name: '<?php echo e(addslashes($unit->unit_kerja_name)); ?>' })"
                    ...
                    <tr>
                        <td colspan="6" class="py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <a href="<?php echo e(route('superadmin.unit-kerja.index')); ?>" class="text-emerald-600 hover:text-emerald-800 font-bold text-sm underline">Reset Pencarian</a>
                            </div>
                        </td>
                    </tr>
                    <?php endif; ?>
