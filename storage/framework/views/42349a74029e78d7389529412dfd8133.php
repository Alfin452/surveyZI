    ...
    <div class="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Kelola informasi publik untuk: <span class="font-semibold"><?php echo e($unitKerja->unit_kerja_name); ?></span></p>
            </div>
        </div>
    </div>

    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="<?php echo e(route('unitkerja.admin.profile.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="unit_kerja_name" id="unit_kerja_name" value="<?php echo e($unitKerja->unit_kerja_name); ?>" disabled
                ...
                <div>
                    <div>
                        ...
                        <textarea name="address" id="address" rows="5"
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-teal-500 focus:border-teal-500 sm:text-sm"><?php echo e(old('address', $unitKerja->address)); ?></textarea>
