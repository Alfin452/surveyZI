                        ...
                        <tr class="bg-slate-50/80">
                            ...
                            <th class="px-6 py-5 text-center min-w-[180px]">
                                <div class="flex flex-col items-center">
                                    <span class="text-xs font-bold text-slate-700 uppercase tracking-wide"><?php echo e(Str::limit($section->title, 20)); ?></span>
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors group">
                            ...
                            <td class="px-8 py-5 sticky left-0 bg-white group-hover:bg-slate-50/80 z-20 border-r border-slate-50 shadow-sm">
                                <div class="flex items-center gap-3">
                                    <div class="w-2 h-8 rounded-full <?php echo e($unitReport['total_avg'] >= 3 ? 'bg-emerald-400' : ($unitReport['total_avg'] >= 2 ? 'bg-amber-400' : 'bg-rose-400')); ?>"></div>
                                    <span class="font-bold text-slate-700 text-sm"><?php echo e($unitReport['unit_name']); ?></span>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-5 text-center">
                                <div class="relative inline-block group/tooltip">
                                    <span class="text-sm font-bold <?php echo e($score >= 3 ? 'text-emerald-600' : ($score >= 2 ? 'text-amber-600' : 'text-rose-600')); ?>">
                                    ...
                                    <div class="absolute bottom-0 left-0 w-full h-1 bg-slate-100 rounded-full mt-1 overflow-hidden">
                                        <div class="h-full <?php echo e($score >= 3 ? 'bg-emerald-400' : ($score >= 2 ? 'bg-amber-400' : 'bg-rose-400')); ?>" style="width: <?php echo e(($score/4)*100); ?>%"></div>
                                    </div>
                                </div>
                            </td>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td class="px-6 py-5 text-center sticky right-[100px] bg-white group-hover:bg-slate-50/80 z-10 border-l border-slate-50">
                                <span class="text-lg font-black text-slate-800"><?php echo e(number_format($unitReport['total_avg'], 2)); ?></span>
                            </td>
