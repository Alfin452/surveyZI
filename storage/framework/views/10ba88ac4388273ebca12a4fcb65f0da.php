...
<div class="relative min-h-screen overflow-hidden">
    ...
    <div class="relative z-10 space-y-8">
        ...
        <div class="bg-white/60 backdrop-blur-xl rounded-3xl px-6 py-5 border border-white/40 shadow-lg relative overflow-hidden group hover:shadow-indigo-100/50 transition-all duration-500">
            ...
            <div class="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <h1 class="text-2xl md:text-3xl font-black text-slate-800 tracking-tight">
                            ...
                            $greeting = $hour < 12 ? 'Selamat Pagi' : ($hour < 15 ? 'Selamat Siang' : ($hour < 18 ? 'Selamat Sore' : 'Selamat Malam' ));
                                ?>
                                <?php echo e($greeting); ?>, <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600"><?php echo e(Auth::user()->username); ?></span>
                        </h1>
                ...
                <div class="flex gap-3 mt-2 md:mt-0">
                    <a href="<?php echo e(route('superadmin.programs.create')); ?>" class="flex items-center gap-2 px-4 py-2.5 bg-slate-900 hover:bg-slate-800 text-white rounded-xl font-bold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-xs md:text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                        Buat Survei
                    </a>
                    <a href="<?php echo e(route('superadmin.users.index')); ?>" class="flex items-center gap-2 px-4 py-2.5 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-xl font-bold shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 text-xs md:text-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <?php if (isset($component)) { $__componentOriginal74668f72d6fb924a9f6e2b2936f4f5f9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal74668f72d6fb924a9f6e2b2936f4f5f9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dashboard-stat-card','data' => ['title' => 'Total Program','value' => ''.e($totalPrograms).'','subtext' => 'Program Survei','icon' => 'collection','color' => 'indigo','link' => ''.e(route('superadmin.programs.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Total Program','value' => ''.e($totalPrograms).'','subtext' => 'Program Survei','icon' => 'collection','color' => 'indigo','link' => ''.e(route('superadmin.programs.index')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal74668f72d6fb924a9f6e2b2936f4f5f9)): ?>
<?php $attributes = $__attributesOriginal74668f72d6fb924a9f6e2b2936f4f5f9; ?>
<?php unset($__attributesOriginal74668f72d6fb924a9f6e2b2936f4f5f9); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal74668f72d6fb924a9f6e2b2936f4f5f9)): ?>
<?php $component = $__componentOriginal74668f72d6fb924a9f6e2b2936f4f5f9; ?>
<?php unset($__componentOriginal74668f72d6fb924a9f6e2b2936f4f5f9); ?>
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal74668f72d6fb924a9f6e2b2936f4f5f9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal74668f72d6fb924a9f6e2b2936f4f5f9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dashboard-stat-card','data' => ['title' => 'Unit Kerja','value' => ''.e($totalUnitKerja).'','subtext' => 'Terdaftar Sistem','icon' => 'office-building','color' => 'emerald','link' => ''.e(route('superadmin.unit-kerja.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dashboard-stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Unit Kerja','value' => ''.e($totalUnitKerja).'','subtext' => 'Terdaftar Sistem','icon' => 'office-building','color' => 'emerald','link' => ''.e(route('superadmin.unit-kerja.index')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal74668f72d6fb924a9f6e2b2936f4f5f9)): ?>
<?php $attributes = $__attributesOriginal74668f72d6fb924a9f6e2b2936f4f5f9; ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal74668f72d6fb924a9f6e2b2936f4f5f9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal74668f72d6fb924a9f6e2b2936f4f5f9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dashboard-stat-card','data' => ['title' => 'Total Pengguna','value' => ''.e($totalUsers).'','subtext' => 'Admin & User','icon' => 'users','color' => 'amber','link' => ''.e(route('superadmin.users.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dashboard-stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Total Pengguna','value' => ''.e($totalUsers).'','subtext' => 'Admin & User','icon' => 'users','color' => 'amber','link' => ''.e(route('superadmin.users.index')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal74668f72d6fb924a9f6e2b2936f4f5f9)): ?>
<?php $attributes = $__attributesOriginal74668f72d6fb924a9f6e2b2936f4f5f9; ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal74668f72d6fb924a9f6e2b2936f4f5f9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal74668f72d6fb924a9f6e2b2936f4f5f9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dashboard-stat-card','data' => ['title' => 'Responden Unik','value' => ''.e($totalRespondents).'','subtext' => 'Total Partisipan','icon' => 'chart-bar','color' => 'rose','link' => '#']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dashboard-stat-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Responden Unik','value' => ''.e($totalRespondents).'','subtext' => 'Total Partisipan','icon' => 'chart-bar','color' => 'rose','link' => '#']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal74668f72d6fb924a9f6e2b2936f4f5f9)): ?>
<?php $attributes = $__attributesOriginal74668f72d6fb924a9f6e2b2936f4f5f9; ?>
                ...
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex-1">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100">
                            ...
                            <span class="text-xs text-slate-400 font-medium whitespace-nowrap"><?php echo e($activity->created_at->diffForHumans()); ?></span>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const activeCount = <?php echo json_encode($activePrograms ?? 0, 15, 512) ?>;
        const inactiveCount = <?php echo json_encode($inactivePrograms ?? 0, 15, 512) ?>;
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\surveyZI\resources\views/superadmin/dashboard.blade.php ENDPATH**/ ?>