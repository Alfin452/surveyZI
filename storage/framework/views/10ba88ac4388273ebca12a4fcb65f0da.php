...
<div class="bg-white rounded-lg p-5 border border-gray-200 shadow-sm flex items-start gap-3">
    ...
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1">Selamat datang kembali, <?php echo e(Auth::user()->username); ?>!</p>
    </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-3xl font-bold text-gray-800"><?php echo e($totalPrograms); ?></p>
            </div>
        </div>
        <a href="<?php echo e(route('superadmin.programs.index')); ?>" class="text-sm font-medium text-indigo-600 hover:text-indigo-800 mt-4 inline-block">
            Kelola Program &rarr;
        </a>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-3xl font-bold text-gray-800"><?php echo e($totalUnitKerja); ?></p>
            </div>
        </div>
        <a href="<?php echo e(route('superadmin.unit-kerja.index')); ?>" class="text-sm font-medium text-green-600 hover:text-green-800 mt-4 inline-block">
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
        ...
        <a href="<?php echo e(route('superadmin.users.index')); ?>" class="text-sm font-medium text-yellow-700 hover:text-yellow-900 mt-4 inline-block">
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-3xl font-bold text-gray-800"><?php echo e($totalRespondents ?? 0); ?></p>
            </div>
        </div>
        <a href="<?php echo e(route('superadmin.programs.index')); ?>" class="text-sm font-medium text-blue-600 hover:text-blue-800 mt-4 inline-block">
