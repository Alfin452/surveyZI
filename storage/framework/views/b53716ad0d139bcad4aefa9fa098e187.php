...
<div class="space-y-1">
    ...
    <div class="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
        <div class="flex flex-col md:flex-row md:justify-between md:items-start">
            <div>
                ...
                <nav class="text-sm mb-2 font-medium text-gray-500" aria-label="Breadcrumb">
                    <ol class="list-none p-0 inline-flex">
                        <li class="flex items-center"><a href="<?php echo e(route('superadmin.dashboard')); ?>" class="hover:text-purple-600">Dashboard</a><span class="mx-2">/</span></li>
                        <li class="flex items-center"><a href="<?php echo e(route('superadmin.programs.index')); ?>" class="hover:text-purple-600">Program Survei</a><span class="mx-2">/</span></li>
                        <li class="flex items-center"><a href="<?php echo e(route('superadmin.programs.questions.index', $program)); ?>" class="hover:text-purple-600">Kelola Pertanyaan</a><span class="mx-2">/</span></li>
            ...
            <div class="mt-4 md:mt-0 flex space-x-2 self-start md:self-end">
                <a href="<?php echo e(route('superadmin.programs.index', $program)); ?>" class="bg-white text-gray-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition border border-gray-300 shadow-sm">
                    Kembali
                </a>
            </div>
        </div>
    ...
    <div class="bg-white p-5 rounded-lg shadow-sm border border-gray-200">
        <form action="<?php echo e(route('superadmin.programs.results', $program)); ?>" method="GET">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="<?php echo e(route('superadmin.programs.results', $program)); ?>" class="w-full inline-flex justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50">
                        Reset
                    </a>
                </div>
            </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        ...
        <div class="mt-4">
            <p class="text-4xl font-bold text-indigo-600"><?php echo e($totalRespondents); ?></p>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\surveyZI\resources\views/superadmin/programs/results/show.blade.php ENDPATH**/ ?>