...
<div class="relative z-10 space-y-8">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <nav class="flex items-center text-xs font-medium text-slate-500 mb-1 space-x-2">
                        <a href="<?php echo e(route('superadmin.programs.index')); ?>" class="hover:text-purple-600 transition-colors">Program</a>
                    ...
                    <p class="text-slate-500 text-sm font-medium mt-0.5 max-w-xl truncate">
                        Data masuk untuk: <span class="text-purple-600 font-bold"><?php echo e($program->title); ?></span>
                    </p>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-gradient-to-br from-purple-600 to-indigo-600 rounded-3xl p-6 shadow-xl shadow-purple-200 text-white relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="flex items-baseline gap-2">
                    <h2 class="text-5xl font-black"><?php echo e($totalRespondents); ?></h2>
        ...
        <div class="lg:col-span-3 bg-white/60 backdrop-blur-xl border border-white/40 shadow-lg rounded-3xl p-6 flex flex-col justify-center">
            <form action="<?php echo e(route('superadmin.programs.results', $program)); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="<?php echo e(route('superadmin.programs.results', $program)); ?>" class="px-4 py-3 bg-white text-slate-500 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors shadow-sm" title="Reset Filter">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            <div class="p-6 bg-slate-50/50 border-b border-slate-100 flex gap-4 items-start">
                ...
                <h3 class="text-lg font-bold text-slate-800 leading-snug pt-1">
                    <?php echo e($questionData['question_body']); ?>
                ...
                <div class="lg:col-span-2 flex justify-center">
                    <div class="relative w-full max-w-[280px] aspect-square">
                        ...
                        <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                            <span class="text-3xl font-black text-slate-700"><?php echo e($questionData['data']->sum()); ?></span>
                                ...
                                <tr class="hover:bg-slate-50/80 transition-colors">
                                    <td class="px-5 py-3 font-medium text-slate-700">
                                        <div class="flex items-center gap-2">
                                            <span class="w-2 h-2 rounded-full" style="background-color: <?php echo e(['#818cf8', '#34d399', '#fbbf24', '#f87171', '#a78bfa'][$optionIndex % 5]); ?>"></span>
                                            <?php echo e($option->option_body); ?>

                                        </div>
                                    </td>
                                    <td class="px-5 py-3 text-center font-bold text-slate-600"><?php echo e($count); ?></td>
