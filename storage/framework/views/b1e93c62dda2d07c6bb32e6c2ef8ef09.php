        ...
        <div class="container mx-auto px-4 mb-8">
            <div class="bg-white border border-slate-200 rounded-lg shadow-sm p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div class="flex items-center gap-5 w-full md:w-auto">
                    <a href="<?php echo e(route('home')); ?>" class="p-3 rounded-md bg-slate-50 text-slate-500 hover:bg-emerald-600 hover:text-white transition-colors border border-slate-200">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-1 text-[11px] font-bold text-slate-500 uppercase tracking-wider">
                            <span><?php echo e($unitKerja->unit_kerja_name); ?></span>
        ...
        <div x-show="showMobileNav" class="fixed inset-0 z-50 lg:hidden" style="display: none;">
            ...
            <div class="absolute right-0 top-0 bottom-0 w-80 bg-white shadow-2xl p-8 overflow-y-auto"
                ...
                <div class="space-y-8">
                    ...
                    <?php $__currentLoopData = $program->questionSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sIndex => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <div class="text-[10px] font-bold text-slate-400 uppercase mb-4 tracking-wider">Bagian <?php echo e($sIndex + 1); ?></div>
                        <div class="grid grid-cols-5 gap-3">
                            <?php $__currentLoopData = $section->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button" @click="jumpToSection(<?php echo e($sIndex); ?>, 'q-<?php echo e($question->id); ?>'); showMobileNav = false"
                                class="h-10 rounded-2xl text-xs font-bold flex items-center justify-center transition-all"
                                :class="isAnswered(<?php echo e($question->id); ?>) ? 'bg-emerald-500 text-white shadow-md shadow-emerald-200' : 'bg-slate-50 text-slate-400'">
