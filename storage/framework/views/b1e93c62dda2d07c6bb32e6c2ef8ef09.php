...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($program->title)]); ?>
    ...
    <div x-data="{
            step: 0,
            totalSteps: <?php echo e($program->questionSections->count()); ?>,
            answers: <?php echo e(json_encode((object)$oldAnswers)); ?>, // Load old inputs
            sectionMap: <?php echo e(json_encode($sectionMap)); ?>,
            allQuestions: <?php echo e(json_encode($allQuestionIds)); ?>,
            showMobileNav: false,
            ...
            <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-5 md:p-6 relative overflow-hidden">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div class="flex items-start gap-4 w-full md:w-auto pr-12 md:pr-0 relative z-10">
                        ...
                        <a href="<?php echo e(route('home')); ?>" class="shrink-0 p-2.5 md:p-3 rounded-xl bg-slate-50 text-slate-500 hover:bg-emerald-600 hover:text-white transition-colors border border-slate-200 shadow-sm">
                        ...
                        <div class="min-w-0 flex-1">
                            <div class="flex flex-wrap items-center gap-x-2 gap-y-1 mb-1.5 text-[10px] md:text-[11px] font-bold text-slate-500 uppercase tracking-wider">
                                <span class="truncate max-w-[150px] md:max-w-none"><?php echo e($unitKerja->unit_kerja_name); ?></span>
                    ...
                    <div class="w-full md:w-auto flex flex-col md:items-end gap-4 relative z-10">
                        ...
                        <div class="flex flex-col md:flex-col gap-4 w-full md:w-auto">
                            ...
                            <?php if($program->requires_pre_survey): ?>
                            <a href="<?php echo e(route('public.pre-survey.create', ['program' => $program->alias, 'unitKerja' => $unitKerja->alias])); ?>"
                            ...
                            <div class="order-1 md:order-2 w-full md:w-64 flex flex-col gap-2">
                                <div class="flex justify-between text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                                    ...
                                    <span x-text="Math.round(((Object.keys(answers).length) / <?php echo e($program->questionSections->flatMap->questions->count()); ?>) * 100) + '%'"></span>
                                </div>
                                <div class="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                                    <div class="h-full bg-emerald-500 transition-all duration-500 ease-out"
                                        :style="`width: ${((Object.keys(answers).length) / <?php echo e($program->questionSections->flatMap->questions->count()); ?>) * 100}%`"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="flex-1 container mx-auto px-4">
            <div class="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <?php if($program->questionSections->count() > 0): ?>
                <aside class="hidden lg:block w-80 shrink-0 sticky top-32">
                    <div class="bg-white rounded-[2rem] shadow-[0_10px_30px_-10px_rgba(0,0,0,0.05)] overflow-hidden flex flex-col max-h-[calc(100vh-10rem)]">
                        ...
                        <div class="p-6 overflow-y-auto nav-scroll space-y-8 flex-1">
                            <?php $navIndex = 1; ?>
                            <?php $__currentLoopData = $program->questionSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sIndex => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <div class="flex justify-between items-center mb-4">
                                    <span class="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Bagian <?php echo e($sIndex + 1); ?></span>
                                    <span x-show="step === <?php echo e($sIndex); ?>" class="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]"></span>
                                </div>
                                <div class="grid grid-cols-5 gap-2">
                                    ...
                                    <button type="button" @click="jumpToSection(<?php echo e($sIndex); ?>, 'q-<?php echo e($question->id); ?>')"
                                        ...
                                        :class="isAnswered(<?php echo e($question->id); ?>) 
                                                ? 'bg-emerald-500 text-white shadow-md shadow-emerald-200 transform scale-105' 
                                                : (step === <?php echo e($sIndex); ?> ? 'bg-slate-800 text-white shadow-lg shadow-slate-300 scale-110' : 'bg-slate-50 text-slate-400 hover:bg-emerald-50 hover:text-emerald-500')">
                                        <?php echo e($navIndex++); ?>
                ...
                <div class="flex-1 w-full min-w-0">
                    <form id="surveyForm" action="<?php echo e(route('public.survey.storeResponse', ['program' => $program, 'unitKerja' => $unitKerja])); ?>" method="POST">
                        <?php echo csrf_field(); ?>

                        <?php if($program->questionSections->count() > 0): ?>
                        <?php $__currentLoopData = $program->questionSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div x-show="step === <?php echo e($index); ?>" x-cloak
                            ...
                            <div class="px-4 md:px-0">
                                <span class="inline-block px-3 py-1 rounded-lg bg-emerald-50 text-emerald-600 text-[10px] font-bold uppercase tracking-widest mb-3">
                                    Bagian <?php echo e($index + 1); ?>

                                </span>
                                <h2 class="text-3xl md:text-4xl font-black text-slate-900 mb-4 tracking-tight"><?php echo e($section->title); ?></h2>
                                <?php if($section->description): ?>
                                <p class="text-slate-500 text-lg leading-relaxed max-w-3xl"><?php echo e($section->description); ?></p>
                                <?php endif; ?>
                            </div>

                            
                            <div class="space-y-8">
                                <?php $__empty_1 = true; $__currentLoopData = $section->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qIndex => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <div id="q-<?php echo e($question->id); ?>"
                                    ...
                                    :class="isAnswered(<?php echo e($question->id); ?>) ? 'bg-gradient-to-br from-white to-emerald-50/30' : ''">

                                    
                                    <div x-show="isAnswered(<?php echo e($question->id); ?>)"
                                    ...
                                    <div class="flex gap-6">
                                        ...
                                        <div class="shrink-0 text-3xl font-black text-slate-200 select-none group-hover:text-emerald-100 transition-colors duration-500">
                                            <?php echo e(str_pad($qNumber++, 2, '0', STR_PAD_LEFT)); ?>

                                        </div>

                                        <div class="flex-1 pt-1.5">
                                            <h3 class="text-xl font-bold text-slate-800 mb-8 leading-relaxed">
                                                <?php echo e($question->question_body); ?>
                                            ...
                                            <div class="grid gap-4">
                                                ...
                                                <label class="relative cursor-pointer group/opt">
                                                    <input type="radio"
                                                        ...
                                                        @click="handleAnswer(<?php echo e($question->id); ?>, '<?php echo e($option->id); ?>', '<?php echo e($nextElementId); ?>')"
                                                        class="peer sr-only">
                        ...
                        <div class="text-center py-32 bg-white rounded-[3rem] shadow-sm">
                            ...
                            <a href="<?php echo e(route('home')); ?>" class="px-8 py-3.5 bg-slate-900 text-white rounded-2xl text-sm font-bold hover:bg-slate-800 transition-all">Kembali</a>
                        </div>
                        <?php endif; ?>
            ...
            <div class="absolute right-0 top-0 bottom-0 w-[85%] max-w-[320px] bg-white shadow-2xl flex flex-col h-full border-l border-slate-100 pt-20"
                ...
                <div class="flex-1 overflow-y-auto p-5 custom-scrollbar bg-white">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="rounded-2xl border transition-colors duration-300 <?php echo e($loop->index == 0 ? 'mt-1' : ''); ?>"
                            :class="step === <?php echo e($sIndex); ?> ? 'bg-emerald-50/50 border-emerald-100' : 'bg-slate-50/50 border-slate-100'">

                            <div class="p-4">
                                <div class="flex justify-between items-center mb-4">
                                    <span class="text-[10px] font-black uppercase tracking-widest px-2 py-1 rounded-md"
                                        :class="step === <?php echo e($sIndex); ?> ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-200 text-slate-500'">
                                        Bagian <?php echo e($sIndex + 1); ?>

                                    </span>

                                    
                                    <div x-show="step === <?php echo e($sIndex); ?>" class="flex items-center gap-1.5">
                                ...
                                <div class="grid grid-cols-5 gap-2">
                                    <?php $__currentLoopData = $section->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button type="button"
                                        @click="jumpToSection(<?php echo e($sIndex); ?>, 'q-<?php echo e($question->id); ?>'); showMobileNav = false"
                                        ...
                                        :class="isAnswered(<?php echo e($question->id); ?>) 
                                                ...
                                                : (step === <?php echo e($sIndex); ?> ? 'bg-white ring-2 ring-emerald-400 text-emerald-700' : 'bg-white border border-slate-200 text-slate-400 hover:border-slate-300')">
                                        <?php echo e($mGlobalIndex++); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\surveyZI\resources\views/public/fill.blade.php ENDPATH**/ ?>