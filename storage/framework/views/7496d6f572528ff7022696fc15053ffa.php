...
<div class="relative z-10 space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-500 text-sm font-medium mt-0.5 max-w-md truncate">
                        Mengubah: <span class="text-indigo-600 font-bold">"<?php echo e(Str::limit($question->question_body, 40)); ?>"</span>
                    </p>
                </div>
            </div>
    ...
    <form action="<?php echo e(route('superadmin.sections.questions.update', ['section' => $section, 'question' => $question])); ?>" method="POST">
        ...
        <?php echo $__env->make('superadmin.programs.questions._form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </form>
