...
<body class="bg-slate-50 h-screen overflow-hidden flex items-center justify-center relative">
    ...
    <div class="relative z-10 w-full max-w-md p-4">
        <div class="bg-white/70 backdrop-blur-xl border border-white/60 shadow-xl rounded-3xl p-10 text-center relative">
            ...
            <div class="space-y-4">
                <a href="<?php echo e(route('google.redirect')); ?>" class="group relative flex items-center justify-center gap-3 w-full py-4 px-6 bg-white border-2 border-slate-100 hover:border-indigo-100 rounded-2xl shadow-sm hover:shadow-xl hover:shadow-indigo-100 hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="mt-10 pt-6 border-t border-slate-100">
                <a href="<?php echo e(route('home')); ?>" class="text-sm font-bold text-slate-400 hover:text-slate-600 transition-colors">
...
</html><?php /**PATH C:\laragon\www\surveyZI\resources\views/auth/login-public.blade.php ENDPATH**/ ?>