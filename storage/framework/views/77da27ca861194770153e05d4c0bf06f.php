    ...
    <div class="flex h-full">
        ...
        <aside
            ...
            <div class="flex flex-col items-center justify-center pt-4 mb-6">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo UIN" class="w-14 h-14 rounded-full shadow-lg mb-3">
            ...
            <nav class="flex-1 space-y-2">
                <a href="<?php echo e(route('superadmin.dashboard')); ?>"
                    ...
                    class="flex items-center gap-3 p-3 rounded-lg transition-colors
                            <?php echo e(request()->routeIs('superadmin.dashboard') ? 'bg-gray-100 text-gray-900 font-semibold shadow' : 'text-gray-400 hover:bg-gray-800 hover:text-white'); ?>">
                ...
                <a href="<?php echo e(route('superadmin.programs.index')); ?>"
                    @click="setTimeout(() => $store.globals.isLoading = true, 300)"
                    class="flex items-center gap-3 p-3 rounded-lg transition-colors
                            <?php echo e(request()->routeIs('superadmin.programs.*') ? 'bg-gray-100 text-gray-900 font-semibold shadow' : 'text-gray-400 hover:bg-gray-800 hover:text-white'); ?>">
                ...
                <a href="<?php echo e(route('superadmin.unit-kerja.index')); ?>"
                    @click="setTimeout(() => $store.globals.isLoading = true, 300)"
                    class="flex items-center gap-3 p-3 rounded-lg transition-colors
                            <?php echo e(request()->routeIs('superadmin.unit-kerja.*') ? 'bg-gray-100 text-gray-900 font-semibold shadow' : 'text-gray-400 hover:bg-gray-800 hover:text-white'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('superadmin.users.index')); ?>"
                    @click="setTimeout(() => $store.globals.isLoading = true, 300)"
                    class="flex items-center gap-3 p-3 rounded-lg transition-colors
                            <?php echo e(request()->routeIs('superadmin.users.*') ? 'bg-gray-100 text-gray-900 font-semibold shadow' : 'text-gray-400 hover:bg-gray-800 hover:text-white'); ?>">
                ...
                <a href="<?php echo e(route('superadmin.reports.index')); ?>"
                    @click="setTimeout(() => $store.globals.isLoading = true, 300)"
                    class="flex items-center gap-3 p-3 rounded-lg transition-colors
                            <?php echo e(request()->routeIs('superadmin.reports.*') ? 'bg-gray-100 text-gray-900 font-semibold shadow' : 'text-gray-400 hover:bg-gray-800 hover:text-white'); ?>">
