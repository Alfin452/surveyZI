        ...
        <nav class="container mx-auto px-4 sm:px-6 lg:px-8" x-data="{ mobileMenuOpen: false, scrolled: false }"
            ...
            <div class="flex items-center justify-between h-14 sm:h-16">
                ...
                <div class="hidden md:flex items-center space-x-1 relative z-10">
                    ...
                    <a href="{{ route('home') }}" class="px-3 py-1.5 text-sm font-bold text-gray-700 hover:text-teal-600 transition-all duration-200 relative group rounded-lg hover:bg-teal-50">
                        Beranda
                    ...
                    <a href="{{ route('public.tentang') }}" class="px-3 py-1.5 text-sm font-bold text-gray-700 hover:text-teal-600 transition-all duration-200 relative group rounded-lg hover:bg-teal-50">
                        Tentang
                        <span class="absolute bottom-0 left-1/2 transform -translate-x-1/2 h-0.5 bg-gradient-to-r from-cyan-600 to-teal-600 rounded-full transition-all duration-300 
                                     {{ request()->routeIs('public.tentang') ? 'w-3/4' : 'w-0 group-hover:w-3/4' }}">
                        </span>
                    </a>
                    <a href="{{ route('public.programs.list') }}" class="px-3 py-1.5 text-sm font-bold text-gray-700 hover:text-teal-600 transition-all duration-200 relative group rounded-lg hover:bg-teal-50">
                        Program Survei
                        <span class="absolute bottom-0 left-1/2 transform -translate-x-1/2 h-0.5 bg-gradient-to-r from-cyan-600 to-teal-600 rounded-full transition-all duration-300 
                ...
                <div class="hidden md:flex items-center">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-cloak x-show="open" @click.away="open = false"
                            ...
                            <div class="py-1">
                                <a href="{{ route('public.profile') }}" class="flex items-center px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gradient-to-r hover:from-cyan-50 hover:to-teal-50 transition-colors">
                                ...
                                <a href="{{ route('public.profile.history') }}" class="flex items-center px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gradient-to-r hover:from-cyan-50 hover:to-teal-50 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    @else
                    <a href="{{ route('login') }}" class="relative inline-flex items-center bg-gradient-to-r from-cyan-600 via-teal-600 to-blue-600 text-white px-5 py-2 rounded-lg font-bold overflow-hidden group shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5 hover:scale-105">
            ...
            <div x-cloak x-show="mobileMenuOpen"
                ...
                <!-- Beranda -->
                <a href="{{ route('home') }}"
                    @click.prevent="mobileMenuOpen = false; setTimeout(() => window.location = '{{ route('home') }}', 100)"
                ...
                <a href="{{ route('public.tentang') }}"
                    @click.prevent="mobileMenuOpen = false; setTimeout(() => window.location = '{{ route('public.tentang') }}', 100)"
                    class="nav-link-anim flex items-center px-3 py-2 text-gray-700 hover:bg-gradient-to-r hover:from-cyan-50 hover:to-teal-50 hover:text-teal-600 rounded-lg transition-all font-bold group">
                    <div class="w-8 h-8 bg-gradient-to-br from-cyan-100 to-teal-100 rounded-lg flex items-center justify-center mr-2 group-hover:scale-110 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <a href="{{ route('public.programs.list') }}"
                    @click.prevent="mobileMenuOpen = false; setTimeout(() => window.location = '{{ route('public.programs.list') }}', 100)"
                    class="nav-link-anim flex items-center px-3 py-2 text-gray-700 hover:bg-gradient-to-r hover:from-cyan-50 hover:to-teal-50 hover:text-teal-600 rounded-lg transition-all font-bold group">
                    <div class="w-8 h-8 bg-gradient-to-br from-cyan-100 to-teal-100 rounded-lg flex items-center justify-center mr-2 group-hover:scale-110 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                ...
                <div class="pt-2 border-t border-gray-100 mt-2">
                    <a href="{{ route('login') }}"
                        @click.prevent="mobileMenuOpen = false; setTimeout(() => window.location = '{{ route('login') }}', 100)"
                ...
                <div class="pt-2 border-t border-gray-100 mt-2">
                    ...
                    <a href="{{ route('public.profile') }}"
                        @click.prevent="mobileMenuOpen = false; setTimeout(() => window.location = '{{ route('public.profile') }}', 100)"
                    ...
                    <a href="{{ route('public.profile.history') }}"
                        @click.prevent="mobileMenuOpen = false; setTimeout(() => window.location = '{{ route('public.profile.history') }}', 100)"
                        class="flex items-center px-3 py-2 text-gray-700 hover:bg-teal-50 rounded-lg transition-colors font-semibold text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="{{ route('home') }}" class="hover:text-cyan-400 transition-colors flex items-center group">
                                <span class="w-1.5 h-1.5 bg-cyan-400 rounded-full mr-2 group-hover:w-3 transition-all"></span>
                                Beranda
                            </a></li>
                        <li><a href="{{ route('public.tentang') }}" class="hover:text-cyan-400 transition-colors flex items-center group">
                                <span class="w-1.5 h-1.5 bg-cyan-400 rounded-full mr-2 group-hover:w-3 transition-all"></span>
                                Tentang Kami
                            </a></li>
                        <li><a href="{{ route('public.programs.list') }}" class="hover:text-cyan-400 transition-colors flex items-center group">
                                <span class="w-1.5 h-1.5 bg-cyan-400 rounded-full mr-2 group-hover:w-3 transition-all"></span>
                                Program Survei
                            </a></li>
                        <li><a href="{{ route('login') }}" class="hover:text-cyan-400 transition-colors flex items-center group">
                                <span class="w-1.5 h-1.5 bg-cyan-400 rounded-full mr-2 group-hover:w-3 transition-all"></span>
                                Login
                            </a></li>
                    </ul>
            ...
            <div class="border-t border-white/10 pt-6 text-center">
                <p class="text-sm text-gray-400">
                    &copy; {{ date('Y') }} <span class="font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-teal-400">Muhammad Alfin Nur Huda</span>. All rights reserved.
                </p>
