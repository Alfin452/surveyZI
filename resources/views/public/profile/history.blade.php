        ...
        <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden section-title-anim">
            ...
            <div class="p-6 sm:p-8">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex flex-wrap items-center gap-3 text-xs text-slate-500">
                                <span class="flex items-center gap-1">
                                    ...
                                    {{ $response->unitKerja->unit_kerja_name }}
                                </span>
                                ...
                                <span class="flex items-center gap-1">
                                    ...
                                    {{ \Carbon\Carbon::parse($response->completed_at)->format('d M Y, H:i') }}
                                </span>
                            </div>
                        </div>
                ...
                <div class="py-16 text-center">
                    ...
                    <a href="{{ route('home') }}" class="inline-flex items-center justify-center px-6 py-2.5 bg-slate-900 text-white rounded-xl text-sm font-bold hover:bg-indigo-600 transition-all shadow-lg shadow-slate-200">
                        Mulai Isi Survei
                    </a>
                </div>
                @endforelse
