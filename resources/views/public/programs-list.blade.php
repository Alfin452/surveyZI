<x-guest-layout title="Daftar Program Survei">
    ...
    <section class="relative pb-24 bg-slate-50 min-h-screen"
        ...
        {{-- REAL DATA GRID (CENTER OF WINDOW) --}}
        <div x-show="!isSearching"
            ...
            {{-- Empty State Search --}}
            <div class="w-full py-12 text-center" x-cloak x-show="search !== '' && !isSearching && $el.parentElement.querySelectorAll('.program-card-anim[style*=\'display: none\']').length === {{ count($programs) }}">
