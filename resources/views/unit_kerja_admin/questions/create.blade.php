...
<div class="p-4 sm:p-6">
    ...
    {{-- Form --}}
    {{-- Mengirimkan parameter $survey ke route store --}}
    <form action="{{ route('unitkerja.admin.surveys.questions.store', $survey) }}" method="POST">
        @csrf
        @include('unit_kerja_admin.questions._form')
    </form>
</div>
@endsection