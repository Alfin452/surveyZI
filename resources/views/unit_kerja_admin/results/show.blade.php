...
<div class="space-y-3">
            ...
            <div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Unit: <span class="font-semibold">{{ $unitKerja->unit_kerja_name }}</span></p>
                    </div>
                </div>
            </div>
            <div class="mt-4 md:mt-0 flex space-x-2 self-start md:self-end">
                {{-- PERBAIKAN: Menambahkan shadow & border konsisten --}}
                <a href="{{ route('unitkerja.admin.programs.index') }}" class="bg-white text-gray-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition border border-gray-300 shadow-sm">
                    Kembali
                </a>
            </div>
        </div>
    ...
    <div class="bg-white p-5 rounded-lg shadow-sm border border-gray-200">
        <form action="{{ route('unitkerja.admin.programs.results', $program) }}" method="GET">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-end space-x-2">
                    ...
                    <a href="{{ route('unitkerja.admin.programs.results', $program) }}" class="w-full inline-flex justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50">
                        Reset
                    </a>
                </div>
            </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        ...
        <div class="mt-4">
            <p class="text-4xl font-bold text-teal-600">{{ $totalRespondents }}</p>
