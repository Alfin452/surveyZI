...
<div class="relative z-10 space-y-6">
        ...
        <div class="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-500 text-sm font-medium mt-0.5">Perbarui data: <span class="font-bold text-amber-600">{{ $program->title }}</span></p>
                </div>
            </div>
    ...
    {{-- 2. Form Section --}}
    <form action="{{ route('unitkerja.admin.my-programs.update', $program) }}" method="POST"
