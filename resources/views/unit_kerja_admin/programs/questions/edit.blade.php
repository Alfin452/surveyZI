        ...
        <div class="relative flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-500 text-sm font-medium mt-0.5 max-w-md truncate">Mengubah: <span class="text-amber-600 font-bold">"{{ Str::limit($question->question_body, 40) }}"</span></p>
                </div>
            </div>
            <a href="{{ route('unitkerja.admin.programs.questions.index', $program) }}" class="px-5 py-2.5 bg-white text-slate-600 border border-slate-200 rounded-xl font-bold shadow-sm hover:bg-slate-50 hover:text-amber-600 text-sm">Kembali</a>
        </div>
    </div>
