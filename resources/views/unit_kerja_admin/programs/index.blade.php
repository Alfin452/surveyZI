...
{{-- [PERUBAHAN 1] Default activeTab diubah ke 'myPrograms' --}}
<div class="relative z-10 space-y-8" x-data="{ activeTab: 'myPrograms' }">
    ...
    <div class="bg-white/40 backdrop-blur-md p-1.5 rounded-2xl inline-flex items-center gap-2 border border-white/40 shadow-sm">
        ...
        {{-- [PERUBAHAN 2] Tombol "Program Unit Saya" ditaruh di kiri (Pertama) --}}
        ...
        {{-- [PERUBAHAN 2] Tombol "Program Institusional" ditaruh di kanan (Kedua) --}}
    ...
    <div class="relative min-h-[300px]">
        ...
        {{-- [PERUBAHAN 3] TAB: PROGRAM UNIT SAYA (Utama) --}}
        ...
        {{-- [PERUBAHAN 3] TAB: PROGRAM INSTITUSIONAL (Kedua) --}}
