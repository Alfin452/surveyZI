...
@section('content')
{{-- Background Aurora (Nuansa Teal/Emerald untuk Unit Kerja) --}}
...
<div class="relative z-10 space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-500 text-sm font-medium mt-0.5">
                        Program: <span class="font-bold text-teal-600">{{ $program->title }}</span>
                    </p>
                </div>
            </div>

            <a href="{{ route('unitkerja.admin.programs.index', ['tab' => 'myPrograms']) }}"
    ...
    <div class="bg-white/80 backdrop-blur-xl border border-white/60 shadow-xl rounded-3xl p-6 md:p-8">
        ...
        {{-- Menggunakan route update milik unit kerja admin --}}
        <form action="{{ route('unitkerja.admin.my-programs.builder.update', $program) }}" method="POST"
