    ...
    <div class="space-y-1">
        ...
        <div class="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
            <div class="flex flex-col md:flex-row md:justify-between md:items-center">
                ...
                <a href="{{ route('superadmin.users.create') }}" class="mt-4 md:mt-0 bg-indigo-600 text-white px-5 py-2 rounded-lg font-medium hover:bg-indigo-700 transition duration-300 shadow-sm flex items-center space-x-2 self-start md:self-end">
