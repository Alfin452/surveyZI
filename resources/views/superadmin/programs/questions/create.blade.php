...
<div class="space-y-1">
        ...
        <div class="flex items-start gap-3">
            ...
            <div class="flex-shrink-0 bg-indigo-500 text-white p-2 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    {{-- Mengganti ikon '+' dengan 'document-add' agar lebih relevan --}}
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
            </div>
            <div>
                {{-- PERBAIKAN: Menyamakan font size 'text-xl' --}}
                <h1 class="text-xl font-bold text-gray-800">Tambah Pertanyaan Baru</h1>
    ...
    {{-- Form --}}
    <form action="{{ route('superadmin.programs.questions.store', $program) }}" method="POST">
        @csrf
        @include('superadmin.programs.questions._form', ['question' => $question])
    </form>
</div>
@endsection