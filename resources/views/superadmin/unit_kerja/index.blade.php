        ...
        <form action="{{ route('superadmin.unit-kerja.index') }}" method="GET" class="space-y-4 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-4">
            <div>
                ...
                <div class="relative mt-1">
                    ...
                    <input type="text" id="search" name="search" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500" placeholder="e.g. UPT TIPD" value="{{ request('search') }}">
                </div>
            </div>
            <div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-blue-50 transition-colors duration-200">
                    ...
                    {{-- PERBAIKAN: Kolom Stats dirapikan dengan 'divide-x' --}}
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 align-top">
